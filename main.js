...
const objects = {
    ...
    memory_size:                      {role: "state", name: "memory_size", type: "number", read: true, write: false},
    geo_lat:                          {role: "state", name: "geo_lat", type: "number", read: true, write: false},
    geo_lng:                          {role: "state", name: "geo_lng", type: "number", read: true, write: false},
    geo_radius:                       {role: "state", name: "geo_radius", type: "number", read: true, write: false},
    port:                             {role: "state", name: "port", type: "number", read: true, write: false},
    id:                               {role: "state", name: "id", type: "number", read: true, write: false},
    maxCameraSupport:                 {role: "state", name: "maxCameraSupport", type: "number", read: true, write: false},
    liscenseNumber:                   {role: "state", name: "liscenseNumber", type: "number", read: true, write: false},
    isLicenseEnough:                  {role: "state", name: "isLicenseEnough", type: "number", read: true, write: false},
    cameraNumber:                     {role: "state", name: "cameraNumber", type: "number", read: true, write: false},
    timezone_offset:                  {role: "state", name: "timezone_offset", type: "number", read: true, write: false},
    ebox_order:                       {role: "state", name: "ebox_order", type: "number", read: true, write: false},
    ...
    playing_queue_max:                {role: "state", name: "playing_queue_max", type: "number", read: true, write: false},
    serviceVolSize:                   {role: "state", name: "serviceVolSize", type: "number", read: true, write: false},
    onetime_disable_on:               {role: "state", name: "onetime_disable_on", type: "boolean", read: true, write: false},
    notify_on:                        {role: "state", name: "notify_on", type: "boolean", read: true, write: false},
    remindQuickconnectTunnel:         {role: "state", name: "remindQuickconnectTunnel", type: "boolean", read: true, write: false},
    enableVideoRelay:                 {role: "state", name: "enableVideoRelay", type: "boolean", read: true, write: false},
    transcode:                        {role: "state", name: "transcode", type: "boolean", read: true, write: false},
    software_transcode:               {role: "state", name: "software_transcode", type: "boolean", read: true, write: false},
    remux:                            {role: "state", name: "remux", type: "boolean", read: true, write: false},
    hardware_transcode:               {role: "state", name: "hardware_transcode", type: "boolean", read: true, write: false},
    fhd_hardware_transcode:           {role: "state", name: "fhd_hardware_transcode", type: "boolean", read: true, write: false},
    dtv_transcode:                    {role: "state", name: "dtv_transcode", type: "boolean", read: true, write: false},
    ...
    offline_conversion:               {role: "state", name: "offline_conversion", type: "boolean", read: true, write: false},
    dtv:                              {role: "state", name: "dtv", type: "boolean", read: true, write: false},
    is_subtitle_search_enabled:       {role: "state", name: "is_subtitle_search_enabled", type: "boolean", read: true, write: false},
    is_personal_metadata_key_enabled: {role: "state", name: "is_personal_metadata_key_enabled", type: "boolean", read: true, write: false},
    is_manager:                       {role: "state", name: "is_manager", type: "boolean", read: true, write: false},
    is_dtv_enabled:                   {role: "state", name: "is_dtv_enabled", type: "boolean", read: true, write: false},
    onetime_enable_on:                {role: "state", name: "onetime_enable_on", type: "boolean", read: true, write: false},
    support_virtual_library:          {role: "state", name: "support_virtual_library", type: "boolean", read: true, write: false},
    support_usb:                      {role: "state", name: "support_usb", type: "boolean", read: true, write: false},
    support_bluetooth:                {role: "state", name: "support_bluetooth", type: "boolean", read: true, write: false},
    transcode_to_mp3:                 {role: "state", name: "transcode_to_mp3", type: "boolean", read: true, write: false},
    prefer_using_html5:               {role: "state", name: "prefer_using_html5", type: "boolean", read: true, write: false},
    enable_download:                  {role: "state", name: "enable_download", type: "boolean", read: true, write: false},
    disable_upnp:                     {role: "state", name: "disable_upnp", type: "boolean", read: true, write: false},
    audio_show_virtual_library:       {role: "state", name: "audio_show_virtual_library", type: "boolean", read: true, write: false},
    same_subnet:                      {role: "state", name: "same_subnet", type: "boolean", read: true, write: false},
    remote_controller:                {role: "state", name: "remote_controller", type: "boolean", read: true, write: false},
    upnp_browse:                      {role: "state", name: "upnp_browse", type: "boolean", read: true, write: false},
    tag_edit:                         {role: "state", name: "tag_edit", type: "boolean", read: true, write: false},
    remote_player:                    {role: "state", name: "remote_player", type: "boolean", read: true, write: false},
    playlist_edit:                    {role: "state", name: "playlist_edit", type: "boolean", read: true, write: false},
    has_music_share:                  {role: "state", name: "has_music_share", type: "boolean", read: true, write: false},
    enable_personal_library:          {role: "state", name: "enable_personal_library", type: "boolean", read: true, write: false},
    enable_equalizer:                 {role: "state", name: "enable_equalizer", type: "boolean", read: true, write: false},
    dsd_decode_capability:            {role: "state", name: "dsd_decode_capability", type: "boolean", read: true, write: false},
    enable_remote_mount:              {role: "state", name: "enable_remote_mount", type: "boolean", read: true, write: false},
    enable_iso_mount:                 {role: "state", name: "enable_iso_mount", type: "boolean", read: true, write: false},
    support_vfs:                      {role: "state", name: "support_vfs", type: "boolean", read: true, write: false},
    support_sharing:                  {role: "state", name: "support_sharing", type: "boolean", read: true, write: false},
    support_file_request:             {role: "state", name: "support_file_request", type: "boolean", read: true, write: false},
    enable_list_usergrp:              {role: "state", name: "enable_list_usergrp", type: "boolean", read: true, write: false},
    temperature_warn:                 {role: "state", name: "temperature_warn", type: "boolean", read: true, write: false},
    ...
    if (res && res.hdd_info){
        res.hdd_info.forEach((key) => {
            ...
            states.DiskStationManager.hdd_info[diskname] = {
                ...
                'ebox_order':      parseInt(key.ebox_order),
...
function setObject(id, val){
    ...
    adapter.getObject(id, function (err, obj){
        ...
        if (err || !obj){
            adapter.setObject(id, {type: 'state', common: common, native: {}}, () => {
